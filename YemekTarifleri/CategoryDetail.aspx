<%@ Page Title="" Language="C#" MasterPageFile="~/Kullanici.Master" AutoEventWireup="true" CodeBehind="CategoryDetail.aspx.cs" Inherits="YemekTarifleri.CategoryDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ItemTemplate>
        <table class="auto-style4">
            ...
            <tr>
                <td class="auto-style9" style="border-bottom-style: groove; border-bottom-width: medium; border-bottom-color: #FFFFFF">&nbsp;</td>
            </tr>
        </table>
    </ItemTemplate>
</asp:DataList>
